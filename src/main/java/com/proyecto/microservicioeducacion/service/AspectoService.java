...
public class AspectoService {
    ...
    public List<AspectoEducativo> getCursosInformaticos() {
        return Arrays.asList(
                new AspectoEducativo("Cursos:", "Programación en Java, Desarrollo Web, Bases de Datos, Sping Boot, Ciberseguridad, Inteligencia Artificial, Machine Learning, Desarrollo de Apps, Cloud Computing, "),
